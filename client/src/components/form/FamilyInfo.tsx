  ...
  return (
    <div className="w-full h-full border border-gray-400 bg-purple-50 rounded-md  shadow-lg md:m-4">
      <div className="flex flex-col sm:items-center sm:justify-center items-stretch  p-2 ">
        ...
        <form className="w-full md:w-auto bg-white border-pink-600 p-2 md:px-12 my-4 rounded-md border shadow-lg hover:shadow-lg flex flex-col gap-2">
          ...
          {/* Financial Status */}
          <label className="text-sm md:text-lg font-semibold text-cyan-950 p-2 md:p-4 text-center flex flex-col sm:justify-center sm:items-center justify-stretch items-stretch bg-white  rounded-md">
