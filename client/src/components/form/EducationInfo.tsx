...
function EducationInfo({ formData, setFormData }: EducationInfoProps) {
  ...
  useEffect(() => {
    setLocalFormData({
      ...
      university: formData.university || { faculty: "", department: "", session: "" }
    });
  }, [formData]);
  ...
  const handleChange = (
    ...
    field: keyof EducationFormData["ssc"] | keyof EducationFormData["hsc"] | keyof EducationFormData["university"]
  ) => {
    ...
    <div className="w-full">
      <div className="flex flex-col items-center justify-center border border-gray-400 bg-purple-100 p-2 rounded-md md:m-4 shadow-lg">
        ...
        <form className="items-center justify-center w-full md:w-auto bg-white border-pink-600 p-2 md:px-28 my-4 rounded-md border shadow-lg hover:shadow-lg flex flex-col gap-2">
          ...
          <label className="label py-0">জিপিএ</label>
          <input
            type="number"
            step="0.01"
            min="1.00"
          ...
          <label className="label py-0">গ্রুপ</label>
          <select
          ...
          <label className="label py-0">অনুষদ</label>
          <select
          ...
          <label className="label py-0">বিভাগ</label>
          <select
          ...
          <label className="label py-0">সেশন</label>
          <select
          ...
          <hr/>
          <span className="text-gray-900 bg-gray-100 p-2 rounded">For those who continue or complete their masters</span>
