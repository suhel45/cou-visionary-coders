    ...
    <div className="w-full">
      <div className="flex flex-col items-center border border-gray-400 bg-purple-100 p-2 rounded-md md:m-4 shadow-lg">
        ...
        <form className="w-full md:items-center md:justify-center md:w-auto bg-white border-pink-600 p-4 md:px-28 my-4 rounded-md border shadow-lg hover:shadow-lg flex flex-col gap-2">
          ...
          <label className="label">
            আপনার শারিরীক সমস্যা আছে কি না{/*  */}
            <textarea
              name="healthIssues"
              value={localFormData.healthIssues}
              onChange={handleChange}
              className="option-btn p-2 w-full mb-4"
              rows={3}
          ...
          <label className="label">
            ধর্মীয় অনুশাসন কেমন মেনে চলেন{/*  */}
            <textarea
              name="religiousPractice"
              value={localFormData.religiousPractice}
              onChange={handleChange}
              className="option-btn p-2 w-full mb-4"
              rows={3}
          ...
          <label className="label">
            ...
            <textarea
              name="readingHabit"
              value={localFormData.readingHabit}
              onChange={handleChange}
              className="option-btn p-2 w-full mb-4"
              rows={3}
          ...
          <label className="label">
            কেমন লাইফস্টাইল পছন্দ করেন{/*  */}
            <textarea
              name="lifestylePreference"
              value={localFormData.lifestylePreference}
              onChange={handleChange}
              className="option-btn p-2 w-full mb-4"
              rows={3}
          ...
          <label className="label">
            আপনার অন্যান্য আরো কিছু শেয়ার করতে চাইলে{/*  */}
            <textarea
              name="additionalInfo"
