...
const SiblingInfoForm: React.FC<SiblingInfoFormProps> = ({
  ...
  return (
    <div className="flex flex-col items-stretch sm:items-center sm:justify-center justify-stretch border border-gray-400  p-2 rounded-md ">
      <h2 className="bg-violet-900 text-white my-4 py-2 px-6 shadow-sm outline  m-2 rounded-md text-center font-bold text-lg md:text-2xl">
...
<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 w-full">
      ...
      <label className="text-sm md:text-xl font-semibold text-cyan-950 p-2 md:p-4 text-center">
        ...
        <textarea
          ...
          className="block w-full md:w-screen bg-gray-50  font-bold  rounded-md border p-2 border-slate-500 sm:p-4 text-gray-600 shadow-lg ring-1 ring-inset ring-gray-300 focus:ring-2  focus:ring-pink-600 sm:max-w-xs sm:text-sm sm:leading-6"
