...
"
        ...
        <form className="md:items-center md:justify-center w-full md:w-auto bg-white border-pink-600 p-4 md:px-12 my-2 rounded-md border shadow-lg hover:shadow-lg flex flex-col">
          <label
 ...
 py-0"
          >
            ...
            <input
              ...
              className="block w-full md:w-screen bg-gray-50  font-bold  rounded-md border  border-slate-500  text-gray-600 shadow-lg ring-1 ring-inset ring-gray-300 focus:ring-2  focus:ring-pink-600 sm:max-w-xs text-xs sm:leading-6
 p-2"
