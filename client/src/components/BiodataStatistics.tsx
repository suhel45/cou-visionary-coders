...
const BiodataStatistics: React.FC = () => {
  return (
    <>
      <h2 className="text-center text-xl sm:text-3xl rounded-full p-4 mx-4 my-2 sm:m-2 font-extrabold bg-indigo-900 text-white sm:w-1/2 sm:mx-auto">সেবা গ্রহীতার পরিসংখ্যান</h2>
