...
const SidebarComponent = () => {
  ...
  return (
    <div className="flex ">
      ...
      <div
        className={`fixed top-0  left-0 h-full w-64 bg-purple-950 text-white p-4 transform transition-transform ${
      ...
      >
        ...
        <h2 className=" text-white rounded text-center font-bold mb-6 text-2xl p-2">
          Dashboard
        </h2>
        <nav>
          <ul className="space-y-4">
