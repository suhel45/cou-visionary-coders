  ...
  return (
    <Box className="flex flex-col items-center rounded-md m-2 border-2 border-purple-900 p-6">
      <Typography
        ...
        className="text-white bg-indigo-900 py-2 px-4 rounded-full mb-6 font-bold"
      >
      ...
      <Box className="flex flex-col md:flex-row p-4 items-center gap-4">
        <Card className="bg-white shadow-lg p-2 sm:p-6 rounded-2xl flex flex-col items-center text-center">
          <CardContent>
            <Typography
              variant="h6"
              sx={{ fontWeight: 'bold', color: '#4C566A', p: 2 }}
            ...
            <Typography
              variant="h4"
              sx={{ fontWeight: 'bold', color: '#043667', p: 2 }}
              className="text-blue-900 font-bold bg-gray-100 rounded p-2"
            >
              {lastMonthViews}
            </Typography>
            <Typography
              variant="h5"
              sx={{ fontWeight: 'bold', color: '#868e96', p: 2 }}
              className="text-blue-900 font-bold  rounded p-2"
            >
              Last One Month
            </Typography>
          </CardContent>
